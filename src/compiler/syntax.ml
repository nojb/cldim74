...
type ratexpr = 
    {re_desc: ratexpr_desc;
     re_loc: location}
and ratexpr_desc = Oper of string * ratexpr * ratexpr 
             | Neg of ratexpr 
             | Int of int;;

type dimexpr =
     {de_desc:dimexpr_desc;
      de_loc: location}
and dimexpr_desc = DMul of string * dimexpr * dimexpr
             | DExpo of string * dimexpr * ratexpr
             | DVari of string
             | DIdent of global_reference
             | DWithout of int;;
...
and type_expression_desc =
  ...
  | Ztypeconstr of global_reference * type_expression list * dimexpr list
;;
...
and impl_desc =
  ...
  | Ztypedef of (string * string list * string list * type_decl) list
  | Zdimdef of (string * string) list
...
and intf_desc =
  ...
  | Ztypedecl of (string * string list * string list * type_decl) list
  | Zdimdecl of (string * string) list
