...
and type_int dim =
  {typ_desc=Tconstr(constr_type_int, [], [dim]); typ_level=notgeneric}
and type_float dim =
  {typ_desc=Tconstr(constr_type_float, [], [dim]); typ_level=notgeneric}
and type_string =
...
do_list
  ...
  ["unit",
   {ty_constr=constr_type_unit; ty_arity=0; ty_dimarity=0;
     ty_desc=Variant_type[constr_void]};
   "exn",
    {ty_constr=constr_type_exn; ty_arity=0; ty_dimarity=0;
     ty_desc=Variant_type []};
   "bool",
    {ty_constr=constr_type_bool; ty_arity=0;ty_dimarity=0;
     ty_desc=Variant_type [constr_false; constr_true]};
   "int",
    {ty_constr=constr_type_int; ty_arity=0; ty_dimarity=1;
     ty_desc=Abstract_type};
   "float",
    {ty_constr=constr_type_float; ty_arity=0; ty_dimarity=1;
     ty_desc=Abstract_type};
   "string",
    {ty_constr=constr_type_string; ty_arity=0; ty_dimarity=0;
     ty_desc=Abstract_type};
   "char",
    {ty_constr=constr_type_char; ty_arity=0; ty_dimarity=0;
     ty_desc=Abstract_type};
   "list",
    {ty_constr=constr_type_list; ty_arity=1; ty_dimarity=0;
     ty_desc=Variant_type [constr_nil; constr_cons]};
   "vect",
    {ty_constr=constr_type_vect; ty_arity=1; ty_dimarity=0;
     ty_desc=Abstract_type};
   "option",
    {ty_constr=constr_type_option; ty_arity=1;ty_dimarity=0;
