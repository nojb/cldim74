...
and dimtype == (dimtyp * int * int) list;;    (* rational exponents *)
...
and type_abbrev =
    Tnotabbrev
  | Tabbrev of typ list * dimtype list * typ           
                                        (* Parameters and body *)
...
and typ_desc =
  ...
  | Tconstr of type_constr global * typ list * dimtype list  
                                        (* A constructed type *)
and typ_link =
...
and type_components =
  ...
  | Abbrev_type of typ list * dimtype list * typ         (* Abbreviation *)
